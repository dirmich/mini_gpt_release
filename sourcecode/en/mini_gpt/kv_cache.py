...
class CachedSelfAttention(nn.Module):
    ...
    def forward(self, x, cache=None):
        """
        x: (batch, new_tokens, embed_dim) - Only the newly added tokens are input when using cache
        ...
        if cache is not None:
            # Concatenate the newly calculated K and V to the past K and V
        ...
        # New tokens must only be able to see "themselves and all preceding tokens"
