"""Minimal implementation of Selective State Space Model (Educational, pure recursive approach)"""
import torch
...
class SelectiveSSM(nn.Module):
    ...
    def forward(self, x):
        ...
        for t in range(seq_len):
            ...
            # Output: y_t = C_t · h_t  (summed over the state_dim axis)
...
class MambaBlock(nn.Module):
    """Block wrapping SSM: Designed to be interchangeable with Transformer blocks"""
